...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || 'f0fa428ea20b455daba6cd076b400c70',
  ...
  AUTHOR: 'weiliang', // 您的昵称 例如 tangly1024
  BIO: '一个普通的干饭人🍚', // 作者简介
  ...
  CONTACT_GITHUB: 'https://github.com/dafei5350', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '豫ICP备19032697号-2', // 备案号 闽ICP备XXXXXXX
